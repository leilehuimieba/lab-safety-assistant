...
12) 乙醇储存题：必须包含“防火柜”“远离热源/明火”“容器密闭”“标签”。
    首句优先直接写成：乙醇应存放于防火柜，远离热源和明火，容器密闭并贴标签。
13) 新人培训题：必须包含“安全培训”“考核”“设备上岗”。
    首句优先直接写成：新入实验室须完成安全培训，通过考核后方可设备上岗。
输出要求：
- 优先在 `answer / steps / ppe / forbidden / emergency` 中直接覆盖这些词。
- 不要只写泛泛欢迎语或空泛原则。
- 不确定时用保守表述，但不要漏掉关键词。
- 先给结论再给步骤，禁止长篇背景解释。
- 总长度尽量控制在 120~180 字；最多 4 条短句，每条优先 < 28 字。
- 与题目无关的扩展说明省略，避免百科式展开。
...
- “乙醇应如何储存”：回答首句必须逐字写出“乙醇应存放于防火柜，远离热源和明火，容器密闭并贴标签。”
- “新入实验室要完成哪些培训”：回答中必须出现“安全培训、考核、设备上岗”。
"""

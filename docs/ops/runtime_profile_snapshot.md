...
## Env (Sanitized)
- `DIFY_API_BASE` = `http://127.0.0.1:8081`
...
## Docker Containers
- `fake-ollama` | `python:3.11-slim` | `Up 4 hours`
- `docker-plugin_daemon-1` | `langgenius/dify-plugin-daemon:0.5.3-local` | `Up 7 hours`
- `docker-api-1` | `langgenius/dify-api:1.13.0` | `Up 7 hours`
- `docker-worker_beat-1` | `langgenius/dify-api:1.13.0` | `Up 7 hours`
- `docker-worker-1` | `langgenius/dify-api:1.13.0` | `Up 7 hours`
- `docker-nginx-1` | `nginx:latest` | `Up 7 hours`
- `docker-web-1` | `langgenius/dify-web:1.13.0` | `Up 8 hours`
- `docker-sandbox-1` | `langgenius/dify-sandbox:0.2.12` | `Restarting (2) 18 seconds ago`
- `docker-db_postgres-1` | `postgres:15-alpine` | `Up 8 hours (healthy)`
- `docker-redis-1` | `redis:6-alpine` | `Up 8 hours (healthy)`
- `docker-ssrf_proxy-1` | `ubuntu/squid:latest` | `Up 8 hours`
- `docker-qdrant-1` | `langgenius/qdrant:v1.8.3` | `Up 8 hours`

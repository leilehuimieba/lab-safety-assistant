...
| DATA-LOWQ-V82-01 | P1 | todo | 数据清洗员（主）/ 发布与验收负责人（验收） | 清洗 `v8.2` 的 3 条低质量来源（WEB82-024/026/027） | `docs/pipeline/web_seed_v8_2_prefetch_report.md` 中 low quality 从 `3` 降为 `0` 或明确降级为可接受值 | CMD-DATA-01, CMD-DATA-02 |

...
for var in \
  ...
  STABILITY_LIMIT STABILITY_DIFY_TIMEOUT STABILITY_DIFY_RESPONSE_MODE STABILITY_EVAL_CONCURRENCY \
...
STABILITY_ARGS=(
  ...
  --dify-response-mode "${STABILITY_DIFY_RESPONSE_MODE:-streaming}"

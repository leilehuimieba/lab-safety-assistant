#!/usr/bin/env python3
"""
PDF extraction engine with multi-strategy fallback.

Supports pypdf, PyMuPDF, pdfplumber, and OCR (RapidOCR + PyMuPDF rendering).
Includes page-type detection (cover, TOC, front-matter) and repeated-line removal.
"""
...
from libs.ingest_io import clean_document_text
...
def count_pdf_prefix_rare_han(text: str, limit: int = 200) -> int:
    prefix = clean_document_text(text)[:limit]
